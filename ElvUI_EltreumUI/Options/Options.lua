						...
						args = {
							...
							bossiconpick = {
								...
								values = {
									...
									["TYPE18"] = E:TextureString('Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Nameplates\\reaper',':20:20'),
									["TYPE19"] = E:TextureString('Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Nameplates\\reaper2',':20:20'),
									["CUSTOM"] = 'Custom',
								},
								sorting = {
									"TYPE1",
