					...
					elvui = {
						...
						args = {
							...
							addonskins = {
								...
								confirm = true,
								width = 'full',
								disabled = function() return not IsAddOnLoaded("AddOnSkins") end,
							...
							projectazilroka = {
								...
								confirm = true,
								width = 'full',
								disabled = function() return not IsAddOnLoaded("ProjectAzilroka") end,
							...
							windtools = {
								...
								width = 'full',
								hidden = not E.Retail,
								disabled = function() return not IsAddOnLoaded("ElvUI_WindTools") end,
							...
							dynamicstatusicons = {
								...
								confirm = true,
								width = 'full',
								disabled = function() return not IsAddOnLoaded("ElvUI_DynamicStatusIcons") end,
					...
					bossmods = {
						...
						args = {
							...
							bigwigs = {
								...
								desc = L["Reset to Eltruism defaults."],
								width = 'full',
								disabled = function() return not IsAddOnLoaded("BigWigs_Core") end,
							...
							mrt = {
								...
								desc = L["Reset to Eltruism defaults."],
								width = 'full',
								disabled = function() return not IsAddOnLoaded("MRT") end,
					...
					addons = {
						...
						args = {
							...
							dynamiccam = {
								...
								desc = L["Reset to Eltruism defaults."],
								width = 'full',
								disabled = function() return not IsAddOnLoaded("DynamicCam") end,
							...
							immersion = {
								...
								desc = L["Reset to Eltruism defaults."],
								width = 'full',
								disabled = function() return not IsAddOnLoaded("Immersion") end,
							...
							warpdeplete = {
								...
								width = 'full',
								hidden = not E.Retail,
								disabled = function() return not IsAddOnLoaded("WarpDeplete") end,
							...
							questie = {
								...
								width = 'full',
								hidden = E.Retail,
								disabled = function() return not IsAddOnLoaded("Questie") end,
							...
							battlegroundenemies = {
								...
								desc = L["Reset to Eltruism defaults."],
								width = 'full',
								disabled = function() return not IsAddOnLoaded("BattleGroundEnemies") end,
							...
							gladiusex = {
								...
								width = 'full',
								hidden = not E.Retail,
								disabled = function() return not IsAddOnLoaded("GladiusEx") end,
							...
							gladdy = {
								...
								disabled = function() return not IsAddOnLoaded("Gladdy") end,
							...
							gladius = {
								...
								width = 'full',
								hidden = E.Retail or E.Classic,
								disabled = function() return not IsAddOnLoaded("Gladius") end,
							...
							nameplatesct = {
								...
								desc = L["Reset to Eltruism defaults."],
								width = 'full',
								disabled = function() return not IsAddOnLoaded("NameplateSCT") end,
							...
							fct = {
								...
								desc = L["Reset to Eltruism defaults."],
								width = 'full',
								disabled = function() return not IsAddOnLoaded("ElvUI_FCT") end,
					...
					tags = {
						...
						args = {
							...
							hpstatus = {
								order = 2,
								type = "group",
								name = "[eltruism:hpstatus]",
								args = {
									header1 = {
										order = 1,
										type = "description",
										name = E.NewSign..L["Customize Health Status Icons"],
										width = 'full',
										image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
									},
									deadiconpick = {
										...
										style = 'radio',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.hpstatusdeadicon end,
										set = function(_,value) E.db.ElvUI_EltreumUI.otherstuff.hpstatusdeadicon = tostring(value) end,
									},
									dciconpick = {
										order = 163,
										type = 'select',
										...
										style = 'radio',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.hpstatusdcicon end,
										set = function(_,value) E.db.ElvUI_EltreumUI.otherstuff.hpstatusdcicon = tostring(value) end,
									},
								},
							},
							dead = {
								...
								args = {
									header1 = {
										order = 1,
										type = "description",
										name = E.NewSign..L["Customize the Dead Icons"],
										width = 'full',
										image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
									},
									deadiconpick = {
										...
										style = 'radio',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.deadtagicon end,
										set = function(_,value) E.db.ElvUI_EltreumUI.otherstuff.deadtagicon = tostring(value) end,
									},
								},
							},
							dc = {
								...
								args = {
									header1 = {
										order = 1,
										type = "description",
										name = E.NewSign..L["Customize the Disconnected Icons"],
										width = 'full',
										image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
									},
									dciconpick = {
										...
										style = 'radio',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.dctagicon end,
										set = function(_,value) E.db.ElvUI_EltreumUI.otherstuff.dctagicon = tostring(value) end,
									},
								},
							},
						},
				...
				args = {
					general = {
						...
						args = {
							...
							leadericons = {
								type = 'group',
								name = E.NewSign..L["Leader Icons"],
								order = 2,
								args = {
									headerleadericon = {
										order = 161,
										type = "description",
										name = L["Replace Leader icons with Eltruism leader icons"],
										width = 'full',
										image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
									},
									leadericonsenable = {
										...
										name = L["Enable Eltruism Icons"],
										width = 'full',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismleadericons end,
										set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.eltruismleadericons = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									leadericonpick = {
										order = 163,
										type = 'select',
										...
										style = 'radio',
										disabled = function() return not E.db.ElvUI_EltreumUI.otherstuff.eltruismleadericons end,
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.leadericonstype end,
										set = function(_,value) E.db.ElvUI_EltreumUI.otherstuff.leadericonstype = tostring(value) E:StaticPopup_Show('CONFIG_RL') end,
									},
									customleadericons = {
										order = 197,
										type = 'group',
										...
										name = L["Name of file inside Interface\\Addons"],
										args = {
											headerleadericoncustominput = {
												order = 165,
												type = 'input',
												name = L["Example: "].."mytexture.tga or mytexture or mytexture.jpg",
												width = 'full',
												disabled = function() return not E.db.ElvUI_EltreumUI.otherstuff.eltruismleadericons or E.db.ElvUI_EltreumUI.otherstuff.leadericonstype ~= 'CUSTOM' end,
												get = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismleadericonscustom end,
												set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.eltruismleadericonscustom = tostring(value) E:StaticPopup_Show('CONFIG_RL') end,
											},
										},
									},
								},
							...
							assisticons = {
								type = 'group',
								name = E.NewSign..L["Assist Icons"],
								order = 3,
								args = {
									headerassisticon = {
										order = 161,
										type = "description",
										name = L["Replace Raid Assist icons with Eltruism Raid Assist icons"],
										width = 'full',
										image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
									},
									assisticonsenable = {
										...
										name = L["Enable Eltruism Icons"],
										width = 'full',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismassisticons end,
										set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.eltruismassisticons = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									assisticonpick = {
										order = 163,
										type = 'select',
										...
										style = 'radio',
										disabled = function() return not E.db.ElvUI_EltreumUI.otherstuff.eltruismassisticons end,
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.assisticonstype end,
										set = function(_,value) E.db.ElvUI_EltreumUI.otherstuff.assisticonstype = tostring(value) E:StaticPopup_Show('CONFIG_RL') end,
									},
									customassisticons = {
										order = 197,
										type = 'group',
										...
										name = L["Name of file inside Interface\\Addons"],
										args = {
											headerassisticoncustominput = {
												order = 165,
												type = 'input',
												name = L["Example: "].."mytexture.tga or mytexture or mytexture.jpg",
												width = 'full',
												disabled = function() return not E.db.ElvUI_EltreumUI.otherstuff.eltruismassisticons or E.db.ElvUI_EltreumUI.otherstuff.assisticonstype ~= 'CUSTOM' end,
												get = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismassisticonscustom end,
												set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.eltruismassisticonscustom = tostring(value) E:StaticPopup_Show('CONFIG_RL') end,
											},
										},
									},
								},
							...
							lootericons = {
								...
								args = {
									headerlootericon = {
										order = 161,
										type = "description",
										name = L["Replace Master Looter icons with Eltruism Master Looter icons"],
										width = 'full',
										image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
									},
									lootericonsenable = {
										...
										name = L["Enable Eltruism Icons"],
										width = 'full',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismlootericons end,
										set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.eltruismlootericons = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									lootericonpick = {
										order = 163,
										type = 'select',
										...
										style = 'radio',
										disabled = function() return not E.db.ElvUI_EltreumUI.otherstuff.eltruismlootericons end,
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.lootericonstype end,
										set = function(_,value) E.db.ElvUI_EltreumUI.otherstuff.lootericonstype = tostring(value) E:StaticPopup_Show('CONFIG_RL') end,
									},
									customlootericons = {
										order = 197,
										type = 'group',
										...
										name = L["Name of file inside Interface\\Addons"],
										args = {
											headerlootericoncustominput = {
												order = 165,
												type = 'input',
												name = L["Example: "].."mytexture.tga or mytexture or mytexture.jpg",
												width = 'full',
												disabled = function() return not E.db.ElvUI_EltreumUI.otherstuff.eltruismlootericons or E.db.ElvUI_EltreumUI.otherstuff.lootericonstype ~= 'CUSTOM' end,
												get = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismlootericonscustom end,
												set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.eltruismlootericonscustom = tostring(value) E:StaticPopup_Show('CONFIG_RL') end,
											},
										},
									},
								},
							...
							details = {
								...
								args = {
									...
									detailsembedcombat = {
										...
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.skins.detailsembed end,
									...
									detailsdelay = {
										...
										step = 1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.skins.detailsembed or not E.db.ElvUI_EltreumUI.skins.detailsembedooc end,
							...
							other = {
								...
								args = {
									...
									bagsyncskin = {
										...
										width = "full",
										disabled = function() return not IsAddOnLoaded("BagSync") end,
									...
									bugsackskin = {
										...
										width = "full",
										disabled = function() return not IsAddOnLoaded("BugSack") end,
									...
									cliqueskin = {
										...
										width = "full",
										disabled = function() return not IsAddOnLoaded("Clique") end,
									...
									hekiliskin = {
										...
										width = "full",
										disabled = function() return not IsAddOnLoaded("Hekili") end,
									...
									meetinghorn = {
										...
										hidden = E.Retail,
										width = "full",
										disabled = function() return not IsAddOnLoaded("MeetingHorn") end,
									...
									pallypower = {
										...
										hidden = E.Retail,
										width = "full",
										disabled = function() return not IsAddOnLoaded("PallyPower") end,
									...
									simcskin = {
										...
										width = "full",
										hidden = not E.Retail,
										disabled = function() return not IsAddOnLoaded("SimulationCraft") end,
							...
							elvui = {
								...
								args = {
									...
									texture = {
										...
										disabled = function() return not E.db.ElvUI_EltreumUI.skins.elvui.SetTemplate end,
										get = function() return E.db.ElvUI_EltreumUI.skins.elvui.texture end,
										set = function(self,key) E.db.ElvUI_EltreumUI.skins.elvui.texture = key E:StaticPopup_Show('CONFIG_RL') end,
									},
								},
							},
						},
							...
							spark = {
								...
								args = {
									...
									aurabarsparkenable = {
										order = 992,
										type = 'toggle',
										name = E.NewSign..L["Enable on Aura Bars"],
										width = "full",
										get = function() return E.db.ElvUI_EltreumUI.unitframes.sparkcustomcolor.enableaurabars end,
										set = function(_, value) E.db.ElvUI_EltreumUI.unitframes.sparkcustomcolor.enableaurabars = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									linebreak1 = {
										order = 994,
										type = "description",
									...
									sparktexture = {
										...
										desc = L["Select a Texture"],
										values = AceGUIWidgetLSMlists.statusbar,
										disabled = function() return not E.db.ElvUI_EltreumUI.unitframes.sparkcustomcolor.enable or not E.db.ElvUI_EltreumUI.unitframes.sparkcustomcolor.enableaurabars end,
