					...
					waytext = {
						...
						args = {
							...
							enablelimit = {
								...
								name = L["Enable"],
								hidden = function() if E.Retail then return false else return true end end,
								get = function() return E.db.ElvUI_EltreumUI.waypointetasetting.limitmaxdistance end,
							...
							enablelimitd = {
								...
								width = "full",
								hidden = function() if E.Retail then return false else return true end end,
								disabled = function() return not E.db.ElvUI_EltreumUI.waypointetasetting.limitmaxdistance end,
