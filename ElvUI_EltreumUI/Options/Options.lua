					...
					chatOptions = {
						...
						args = {
							...
							classcolormsgscustom = {
								...
								--width = 'double',
								desc = L["Toggle the option on"],
								disabled = function() return not E.db.ElvUI_EltreumUI.chat.enable or not E.db.ElvUI_EltreumUI.chat.looticons or not E.db.ElvUI_EltreumUI.chat.classcolorchat end,
