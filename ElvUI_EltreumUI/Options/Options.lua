				...
				args = {
					general = {
						...
						args = {
							...
							enabletargetmodelCamPosx = {
								type = 'range',
								name = E.NewSign..L["Camera Position X"],
								order = 13,
								min = -1,
								max = 1,
								step = 0.01,
								width = "full",
								disabled = function() return not E.db.ElvUI_EltreumUI.nameplateOptions.targetmodel end,
								get = function() return E.db.ElvUI_EltreumUI.nameplateOptions.cameraposX end,
								set = function(_, value) E.db.ElvUI_EltreumUI.nameplateOptions.cameraposX = value end,
							},
							enabletargetmodelCamPosy = {
								type = 'range',
								name = E.NewSign..L["Camera Position Y"],
								order = 13,
								min = -1,
								max = 1,
								step = 0.01,
								width = "full",
								disabled = function() return not E.db.ElvUI_EltreumUI.nameplateOptions.targetmodel end,
								get = function() return E.db.ElvUI_EltreumUI.nameplateOptions.cameraposY end,
								set = function(_, value) E.db.ElvUI_EltreumUI.nameplateOptions.cameraposY = value end,
							},
							enabletargetmodelCamPosz = {
								type = 'range',
								name = E.NewSign..L["Camera Position Z"],
								order = 13,
								min = -1,
								max = 1,
								step = 0.01,
								width = "full",
								disabled = function() return not E.db.ElvUI_EltreumUI.nameplateOptions.targetmodel end,
								get = function() return E.db.ElvUI_EltreumUI.nameplateOptions.cameraposZ end,
								set = function(_, value) E.db.ElvUI_EltreumUI.nameplateOptions.cameraposZ = value end,
							},
