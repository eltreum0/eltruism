...
local THANKYOU = {
	...
	E:TextGradient('Simpy he fixes a lot of things but he cant see colors right', 0.27,0.72,0.86, 0.51,0.36,0.80, 0.69,0.28,0.94, 0.94,0.28,0.63, 1.00,0.51,0.00, 0.27,0.96,0.43),
	'Shrom',
	'Pat',
	'|cff00c0faBenik|r',
					...
					general = {
						...
						args = {
							...
							roleiconsenable = {
								...
								width = 'full',
								disabled = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismroleiconscustom end,
							...
							roleiconsenablecustom = {
								order = 163,
								type = 'toggle',
								name = E.NewSign..L["Enable Custom Icons"],
								width = 'full',
								disabled = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismroleicons end,
								get = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismroleiconscustom end,
								set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.eltruismroleiconscustom = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							customroleicons = {
								order = 164,
								type = 'group',
								...
								args = {
									headerroleiconcustomtankinput = {
										order = 165,
										type = 'input',
										name = E.NewSign..L["Tank"],
										desc = L["Example: "].."mytexture.tga or mytexture or mytexture.jpg",
										width = 'full',
										disabled = function() return E.db.ElvUI_EltreumUI.otherstuff.eltruismroleicons or not E.db.ElvUI_EltreumUI.otherstuff.eltruismroleiconscustom end,
