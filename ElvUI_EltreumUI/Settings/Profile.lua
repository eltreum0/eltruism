...
P.ElvUI_EltreumUI = {
	...
	unitframes = {
		...
		gradientmode = {
			...
			--castbar
			enablecastbar = false,
			enablecastbarnoninterruptible = false,
			enablecastbarinterrupted = false,
			castbarreactioninterruptable = false,
			classcolorcastbar = false,
			...
			castbarR1custom = 0,
			castbarR2custom = 0.67,
			castbarG1custom = 0.6,
			castbarG2custom = 0.94,
			castbarB1custom = 1,
			castbarB2custom = 1,

			castbarR1noninterruptible = 1,
			castbarR2noninterruptible = 1,
			castbarB1noninterruptible = 0,
			castbarB2noninterruptible = 0.290,
			castbarG1noninterruptible = 0.349,
			castbarG2noninterruptible = 0.196,

			castbarR1noninterruptiblecustom = 1,
			castbarR2noninterruptiblecustom = 1,
			castbarB1noninterruptiblecustom = 0,
			castbarB2noninterruptiblecustom = 0.290,
			castbarG1noninterruptiblecustom = 0.349,
			castbarG2noninterruptiblecustom = 0.196,

			castbarR1interrupted = 0.6,
			castbarR2interrupted = 0.2,
			castbarB1interrupted = 0.6,
			castbarB2interrupted = 0.2,
			castbarG1interrupted = 0.6,
			castbarG2interrupted = 0.2,

			castbarR1interruptedcustom = 0.6,
			castbarR2interruptedcustom = 0.2,
			castbarB1interruptedcustom = 0.6,
			castbarB2interruptedcustom = 0.2,
			castbarG1interruptedcustom = 0.6,
			castbarG2interruptedcustom = 0.2,

			castbarR1interruptable = 1,
			castbarR2interruptable = 1,
			castbarB1interruptable = 0,
			castbarB2interruptable = 0,
			castbarG1interruptable = 0.81,
			castbarG2interruptable = 0.59,

			castbarR1interruptablecustom = 1,
			castbarR2interruptablecustom = 1,
			castbarB1interruptablecustom = 0,
			castbarB2interruptablecustom = 0,
			castbarG1interruptablecustom = 0.81,
			castbarG2interruptablecustom = 0.59,
