...
P.ElvUI_EltreumUI = {
	...
	gradientmode = {
		...
		druidcustomcolorG2 = 0.23921568627451,
		druidcustomcolorB1 = 0.03921568627451,
		druidcustomcolorB2 = 0.007843137254902,
		...
		paladincustomcolorG2 = 0.26666666666667,
		paladincustomcolorB1 = 0.72941176470588,
		paladincustomcolorB2 = 0.53725490196078,
		...
		roguecustomcolorG2 = 0.68627450980392,
		roguecustomcolorB1 = 0.25490196078431,
		roguecustomcolorB2 = 0,
		...
		warriorcustomcolorG2 = 0.31372549019608,
		warriorcustomcolorB1 = 0.24705882352941,
		warriorcustomcolorB2 = 0.2,
