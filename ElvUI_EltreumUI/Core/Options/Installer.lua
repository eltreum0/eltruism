...
function ElvUI_EltreumUI:InstallerOptions()
	...
	ElvUI_EltreumUI.Options.args.installer.args.tab4.args.description1 = E.Libs.ACH:Description(L["Reinstall"].." ".._G.CHAT_LABEL, 2, nil, 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', nil, 3240, 1)
