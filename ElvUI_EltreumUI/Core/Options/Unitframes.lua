...
function ElvUI_EltreumUI:UnitframeOptions()
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.backdrop.args.staticbackdrop = E.Libs.ACH:Toggle(E.NewSign..L["Enable static backdrop texture size"], L["Backdrop Texture will not adjust to the missing health"], 6, nil, false,'full', function() return E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdroptexturestaticsize end, function(_, value) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdroptexturestaticsize = value end, function() return not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end)
