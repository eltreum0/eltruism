...
function ElvUI_EltreumUI:UnitframeOptions()
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.general.args.thinaurabars = E.Libs.ACH:Toggle(L["Thin Aura Bars"], nil, 119, nil, false,'full', function() return E.db.ElvUI_EltreumUI.unitframes.thinmodeaurabars end, function(_, value) E.db.ElvUI_EltreumUI.unitframes.thinmodeaurabars = value E:StaticPopup_Show('CONFIG_RL') end, function() return not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end)
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.backdrop.args.texture = E.Libs.ACH:SharedMediaStatusbar(L["Backdrop Texture"], L["Select a Texture"], 4, "full", function() return E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdroptexture end, function(_,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdroptexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end, function() return not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end)
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.backdrop.args.staticbackdrop = E.Libs.ACH:Toggle(E.NewSign..L["Enable static backdrop texture size"], L["Backdrop Texture will not adjust to the missing health"], 6, nil, false,'full', function() return E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdroptexturestaticsize end, function(_, value) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdroptexturestaticsize = value ElvUI_EltreumUI:GradientColorTableUpdate() end, function() return not E.db.ElvUI_EltreumUI.unitframes.lightmode or not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end)
	ElvUI_EltreumUI.Options.args.unitframes.args.backdrop.args.fliptarget = E.Libs.ACH:Toggle(E.NewSign..L["Invert Target Backdrop"], nil, 6, nil, false,'full', function() return E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.fliptargetbackdrop end, function(_, value) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.fliptargetbackdrop = value ElvUI_EltreumUI:GradientColorTableUpdate() end, function() return not E.db.ElvUI_EltreumUI.unitframes.lightmode or not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end)
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.backdrop.args.backdropalpha = E.Libs.ACH:Range(L["Backdrop Alpha"], L["Change the transparency of the backdrop"], 15, { min = 0, max = 1, step = 0.01 }, "full", function() return E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha end, function(_, value) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha = value ElvUI_EltreumUI:GradientColorTableUpdate() end, function() return not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end)
	ElvUI_EltreumUI.Options.args.unitframes.args.backdrop.args.healthalpha = E.Libs.ACH:Range(L["Health Alpha"], L["Change the transparency of the health"], 15, { min = 0, max = 1, step = 0.01 }, "full", function() return E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.healthalpha end, function(_, value) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.healthalpha = value ElvUI_EltreumUI:GradientColorTableUpdate() end, function() return not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end)
	...
	end, function() return not E.db.ElvUI_EltreumUI.unitframes.sparkcustomcolor.enable end, not E.Modern)
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.models.args.unitframes.args.custommodelpath = E.Libs.ACH:Input(function() if E.Modern then return L["Type the Model ID, such as 165575"] else return L["Type the Model Path, such as spells/arcanebreath.m2"] end end, nil, 5, nil, "full", function() if E.Modern then return tostring(E.db.ElvUI_EltreumUI.unitframes.models.custommodel) else return tostring(E.db.ElvUI_EltreumUI.unitframes.models.custommodelclassic) end end, function(_, value) if E.Modern then E.db.ElvUI_EltreumUI.unitframes.models.custommodel = tonumber(value) else E.db.ElvUI_EltreumUI.unitframes.models.custommodelclassic = tostring(value) end ElvUI_EltreumUI:PlayerUFEffects() ElvUI_EltreumUI:TargetUFEffects() ElvUI_EltreumUI:TargetTargetUFEffects() end, function() return E.db.ElvUI_EltreumUI.unitframes.models.modeltype == 'CLASS' or not E.db.ElvUI_EltreumUI.unitframes.models.unitframe or not E.db.ElvUI_EltreumUI.unitframes.UFmodifications end, nil, function(_, value)
		...
		if E.Modern then if tonumber(value) ~= nil then return true else return E:StaticPopup_Show('ELTRUISMINVALIDMODEL') and false end else return true end end)
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.models.args.castbar.args.custommodelpath = E.Libs.ACH:Input(function() if E.Modern then return L["Type the Model ID, such as 165821"] else return L["Type the Model Path, such as spells/corruption_impactdot_med_base.m2"] end end, nil, 4, nil, "full", function() if E.Modern then return tostring(E.db.ElvUI_EltreumUI.unitframes.models.custommodelcast) else return tostring(E.db.ElvUI_EltreumUI.unitframes.models.custommodelclassiccast) end end, function(_, value) if E.Modern then E.db.ElvUI_EltreumUI.unitframes.models.custommodelcast = tonumber(value) else E.db.ElvUI_EltreumUI.unitframes.models.custommodelclassiccast = tostring(value) end ElvUI_EltreumUI:CastbarEffects() end, function() return E.db.ElvUI_EltreumUI.unitframes.models.modeltypecast == "DEFAULT" or (not E.db.ElvUI_EltreumUI.unitframes.UFmodifications or not E.db.ElvUI_EltreumUI.unitframes.models.castbar) end, nil, function(_, value)
		...
		if E.Modern then if tonumber(value) ~= nil then return true else return E:StaticPopup_Show('ELTRUISMINVALIDMODELCAST') and false end else return true end end)
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.models.args.power.args.custommodelpath = E.Libs.ACH:Input(function() if E.Modern then return L["Type the Model ID, such as 165821"] else return L["Type the Model Path, such as spells/corruption_impactdot_med_base.m2"] end end, nil, 5, nil, "full", function() if E.Modern then return tostring(E.db.ElvUI_EltreumUI.unitframes.models.custommodelpower) else return tostring(E.db.ElvUI_EltreumUI.unitframes.models.custommodelclassicpower) end end, function(_, value) if E.Modern then E.db.ElvUI_EltreumUI.unitframes.models.custommodelpower = tonumber(value) else E.db.ElvUI_EltreumUI.unitframes.models.custommodelclassicpower = tostring(value) end ElvUI_EltreumUI:PlayerUFEffects() end, function() return E.db.ElvUI_EltreumUI.unitframes.models.modeltypepower == "DEFAULT" or (not E.db.ElvUI_EltreumUI.unitframes.UFmodifications or not E.db.ElvUI_EltreumUI.unitframes.models.powerbar) end, nil, function(_, value)
		...
		if E.Modern then if tonumber(value) ~= nil then return true else return E:StaticPopup_Show('ELTRUISMINVALIDMODELPOWER') and false end else return true end end)
end
