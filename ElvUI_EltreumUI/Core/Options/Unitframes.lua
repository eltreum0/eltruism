...
function ElvUI_EltreumUI:UnitframeOptions()
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.portraits.args.portraiteltruism = E.Libs.ACH:Group(L["Portrait"], nil, 4, "tab", nil, nil, function() return E.db.ElvUI_EltreumUI.unitframes.portraits.general.enable end)
