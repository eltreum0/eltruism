...
function ElvUI_EltreumUI:MiscOptions()
	...
	ElvUI_EltreumUI.Options.args.misc.args.general.args.description11 = E.Libs.ACH:Description(L["Click Casting Button"], 30, nil, 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', nil, 3240, 1, "full", not E.Modern)
	ElvUI_EltreumUI.Options.args.misc.args.general.args.ClickCastingShortcut = E.Libs.ACH:Toggle(E.NewSign..L["Add a shortcut to open the Click Casting menu on the Spellbook"], nil, 31, nil, false, "full", function() return E.db.ElvUI_EltreumUI.otherstuff.ClickCastingShortcut end, function(_, value) E.db.ElvUI_EltreumUI.otherstuff.ClickCastingShortcut = value E:StaticPopup_Show('CONFIG_RL') end, nil, not E.Modern)
	...
	ElvUI_EltreumUI.Options.args.misc.args.combat.args.previewdeath = E.Libs.ACH:Execute(_G.PREVIEW or "", nil, 17.5, function() ElvUI_EltreumUI:PlayerDeathAnimation(true) end, nil, false, "full", nil, nil, function() return not (E.db.ElvUI_EltreumUI.skins.playerdeath or E.db.ElvUI_EltreumUI.skins.playerdeathgta or E.db.ElvUI_EltreumUI.skins.playerdeathcustom) end)
	...
	ElvUI_EltreumUI.Options.args.misc.args.afk.args.preview = E.Libs.ACH:Execute(_G.PREVIEW or "", nil, 5.5, function() ElvUI_EltreumUI:PreviewAFKMusic() end, nil, false, "full", nil, nil, function() return not E.db.ElvUI_EltreumUI.otherstuff.afkmusic.enable end)
