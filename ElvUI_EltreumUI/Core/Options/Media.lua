...
function ElvUI_EltreumUI:MediaOptions()
	...
	ElvUI_EltreumUI.Options.args.media.args.general.args.resetmedia = E.Libs.ACH:Execute(L["Reset all Media"], L["Reset all Media"], 2, function() ElvUI_EltreumUI:SetupPrivate() E:StaticPopup_Show('CONFIG_RL') end,nil,true,'full')
	...
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontoutlinedefault = E.Libs.ACH:Execute(L["Defaults"], L["This will set fonts to Eltruism defaults, recommended for 4K"], 12, function() ElvUI_EltreumUI:SetupFontsOutlineDefault()  E:StaticPopup_Show('CONFIG_RL') end,nil,true,"double")
	ElvUI_EltreumUI.Options.args.media.args.general.args.gap3 = E.Libs.ACH:Description('', 13, nil)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontoutlinenone = E.Libs.ACH:Execute(L["None"], L["This will set fonts to no outline"], 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("NONE")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontoutlineoutline = E.Libs.ACH:Execute(L["Outline"], L["This will set fonts to use outline, recommended for 1440p and 1080p"], 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("OUTLINE")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontoutlinethick = E.Libs.ACH:Execute(L["Thick Outline"], L["This will set fonts to use thick outline"], 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("THICKOUTLINE")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontshadow = E.Libs.ACH:Execute(L['|cff888888Shadow|r'], nil, 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("SHADOW")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontshadowoutline = E.Libs.ACH:Execute(L['|cff888888Shadow|r Outline'], nil, 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("SHADOWOUTLINE")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontshadowoutlinethick = E.Libs.ACH:Execute(L['|cff888888Shadow|r Thick'], nil, 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("SHADOWTHICKOUTLINE")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontmono = E.Libs.ACH:Execute(L['|cFFAAAAAAMono|r'], nil, 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("MONOCHROME")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontmonooutline = E.Libs.ACH:Execute(L['|cFFAAAAAAMono|r Outline'], nil, 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("MONOCHROMEOUTLINE")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
	ElvUI_EltreumUI.Options.args.media.args.general.args.fontmonooutlinethick = E.Libs.ACH:Execute(L['|cFFAAAAAAMono|r Thick'], nil, 14, function() ElvUI_EltreumUI:SetupFontsOutlineCustom("MONOCHROMETHICKOUTLINE")  E:StaticPopup_Show('CONFIG_RL') end,nil,true)
