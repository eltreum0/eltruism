...
function ElvUI_EltreumUI:PortraitOptions()
	...
	ElvUI_EltreumUI.Options.args.unitframes.args.portraits.args.portraiteltruism = E.Libs.ACH:Group(ElvUI_EltreumUI.Name, nil, 1, "tab", nil, nil, function() return E.db.ElvUI_EltreumUI.unitframes.portraits.general.enable end)
