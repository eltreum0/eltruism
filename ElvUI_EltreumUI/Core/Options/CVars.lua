...
WorldTextMinSize 6
	...
	ElvUI_EltreumUI.Options.args.cvars.args.camera.args.cameraDistanceMaxZoomFactor = E.Libs.ACH:Range(L["Camera Distance Max Zoom Factor"], L["Maximum Camera Zoom Out"], 2, { min = 1, max = function() if not (E.Mists or E.TBC or E.Wrath or E.Classic) then return 2.6 else return 4 end end, step = 0.1 }, 'full', function() return E.db.ElvUI_EltreumUI.cvars.cameraDistanceMaxZoomFactor end, function(_, value) E.db.ElvUI_EltreumUI.cvars.cameraDistanceMaxZoomFactor = value SetCVar('cameraDistanceMaxZoomFactor', value) end)
	...
	ElvUI_EltreumUI.Options.args.cvars.args.nameplates.args.description4 = E.Libs.ACH:Description(" ", 8, nil, 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', nil, 3240, 1, "full", E.Modern)
	...
	ElvUI_EltreumUI.Options.args.cvars.args.misc = E.Libs.ACH:Group(L["Misc"], nil, 2, nil, nil,nil,nil,not E.Modern)
	ElvUI_EltreumUI.Options.args.cvars.args.misc.args.description1 = E.Libs.ACH:Description(" ", 1, nil, 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', nil, 3240, 1, "full", not E.Modern)
