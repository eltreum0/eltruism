...
ElvUI_EltreumUI.InstallerData = {
	...
	Pages = {
		...
		[3] = function()
			...
			PluginInstallOption1ButtonText:SetFont('Interface\\addons\\ElvUI_EltreumUI\\Media\\Fonts\\Roboto-Bold.TTF', 15, 'OUTLINE')
			PluginInstallFrame.Option2:Show()
			PluginInstallFrame.Option2:Enable()
			...
			PluginInstallOption2ButtonText:SetFont('Interface\\addons\\ElvUI_EltreumUI\\Media\\Fonts\\Exo2-ExtraBold.TTF', 15, 'OUTLINE')
			PluginInstallFrame.Option3:Show()
			PluginInstallFrame.Option3:Enable()
			...
			PluginInstallOption3ButtonText:SetFont('Interface\\addons\\ElvUI_EltreumUI\\Media\\Fonts\\GothamNarrowBlack.TTF', 15, 'OUTLINE')
			PluginInstallFrame.Option4:Show()
			PluginInstallFrame.Option4:Enable()
			...
			PluginInstallOption4ButtonText:SetFont("Fonts\\ARHei.TTF", 15, 'OUTLINE')
		end,
		[4] = function()
