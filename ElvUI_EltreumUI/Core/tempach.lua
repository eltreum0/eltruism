...
function ElvUI_EltreumUI:Configtable()
	...
	-- installer
	ElvUI_EltreumUI.Options.args.installer = ACH:Group('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\install:0:0:0:0|t '..E:TextGradient(L["Installer"], 0.50, 0.70, 1, 0.67, 0.95, 1), nil, 2, 'tab')
	ElvUI_EltreumUI.Options.args.installer.args.desc = ACH:Header('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\install:0:0:0:0|t '..L["Install, Reinstall or Update various parts of Eltruism"], 1)
	...
	-- aurafilters
	ElvUI_EltreumUI.Options.args.aurafilters = ACH:Group('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\aurafilter:0:0:0:0|t '..E:TextGradient(L["Aura Filters"], 0.50, 0.70, 1, 0.67, 0.95, 1), nil, 85, 'tab')
	ElvUI_EltreumUI.Options.args.aurafilters.args.desc = ACH:Header('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\aurafilter:0:0:0:0|t '..L["Choose to show all debuffs/buffs or use default Filters"], 1)
	...
	--addons
	ElvUI_EltreumUI.Options.args.addons = ACH:Group('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\addon:0:0:0:0|t '..E:TextGradient(L["Addons"], 0.50, 0.70, 1, 0.67, 0.95, 1), nil, 85, 'tab')
	ElvUI_EltreumUI.Options.args.addons.args.desc = ACH:Header('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\addon:0:0:0:0|t '..L["Install or update other Addon profiles"], 1)
	...
	--afk
	ElvUI_EltreumUI.Options.args.afk = ACH:Group('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\afk:0:0:0:0|t '..E:TextGradient(L["A.F.K"], 0.50, 0.70, 1, 0.67, 0.95, 1), nil, 85, 'tab')
	ElvUI_EltreumUI.Options.args.afk.args.desc = ACH:Header('|TInterface\\AddOns\\ElvUI_EltreumUI\\Media\\Icons\\afk:0:0:0:0|t '..L["Enhance the AFK screen"], 1)
