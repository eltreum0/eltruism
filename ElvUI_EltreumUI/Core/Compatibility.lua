...
function ElvUI_EltreumUI:CheckCompatibility()
	...
	CheckMerathilisUI(L["Quests Skin"], L["Quests Skin"], "db.ElvUI_EltreumUI.skins.quests", "private.mui.quest.objectiveTracker.enable")
	...
	CheckWindTools(L["LFG List"], L["LFG List"], "db.ElvUI_EltreumUI.skins.groupfinderSpecIcons", "private.WT.misc.lfgList.enable")
