...
function ElvUI_EltreumUI:SetupNamePlates()
	if E.private.nameplates.enable then
		...
		E.db["nameplates"]["colors"]["classResources"]["MAGE"]["ARCANE_CHARGES"]["r"] = 0
		E.db["nameplates"]["colors"]["classResources"]["MAGE"]["ARCANE_CHARGES"]["g"] = 0.62
		E.db["nameplates"]["colors"]["classResources"]["MAGE"]["ARCANE_CHARGES"]["b"] = 1

		--these are the original version of colors from simpy, looks better with gradient
		E.db["nameplates"]["colors"]["classResources"]["SHAMAN"]["MAELSTROM"]["r"] = 0.58
		E.db["nameplates"]["colors"]["classResources"]["SHAMAN"]["MAELSTROM"]["g"] = 0.51
		E.db["nameplates"]["colors"]["classResources"]["SHAMAN"]["MAELSTROM"]["b"] = 0.79
		--these are the second version of colors from simpy, but they are too dark and dont look good with gradient
		--[[E.db["nameplates"]["colors"]["classResources"]["SHAMAN"]["MAELSTROM"]["r"] = 0.35
		E.db["nameplates"]["colors"]["classResources"]["SHAMAN"]["MAELSTROM"]["g"] = 0.15
		E.db["nameplates"]["colors"]["classResources"]["SHAMAN"]["MAELSTROM"]["b"] = 1]]
		...
		E.db["nameplates"]["units"]["ENEMY_NPC"]["auras"]["countXOffset"] = 2
		E.db["nameplates"]["units"]["ENEMY_NPC"]["auras"]["countYOffset"] = -3
		E.db["nameplates"]["units"]["ENEMY_NPC"]["auras"]["durationPosition"] = "TOP"
		E.db["nameplates"]["units"]["ENEMY_NPC"]["auras"]["height"] = 18
		E.db["nameplates"]["units"]["ENEMY_NPC"]["auras"]["keepSizeRatio"] = false
		E.db["nameplates"]["units"]["ENEMY_NPC"]["auras"]["size"] = 25
		...
		E.db["nameplates"]["units"]["ENEMY_NPC"]["health"]["text"]["format"] = "[eltruism:perhpstatus]"
		...
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["auras"]["countXOffset"] = 2
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["auras"]["countYOffset"] = -3
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["auras"]["durationPosition"] = "TOP"
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["auras"]["height"] = 18
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["auras"]["keepSizeRatio"] = false
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["auras"]["size"] = 25
