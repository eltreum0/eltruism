...
function ElvUI_EltreumUI:SetupStyleFilters()
	if E.private["nameplates"]["enable"] == true then
		...
		E.global["nameplate"]["filters"]["EltreumTotems"]["actions"]["scale"] = 1.25
		E.global["nameplate"]["filters"]["EltreumTotems"]["actions"]["usePortrait"] = true
		E.global["nameplate"]["filters"]["EltreumTotems"]["triggers"]["creatureType"]["Totem"] = true
		E.global["nameplate"]["filters"]["EltreumTotems"]["triggers"]["creatureType"]["enable"] = true
		E.global["nameplate"]["filters"]["EltreumTotems"]["triggers"]["isTarget"] = true
		E.global["nameplate"]["filters"]["EltreumTotems"]["triggers"]["notTarget"] = true
		E.global["nameplate"]["filters"]["EltreumTotems"]["triggers"]["playerCanAttack"] = true
		E.global["nameplate"]["filters"]["EltreumTotems"]["triggers"]["priority"] = 14
