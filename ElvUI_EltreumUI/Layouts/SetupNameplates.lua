...
function ElvUI_EltreumUI:SetupNamePlates(addon)
	if E.private["nameplates"]["enable"] == true then
		if addon == 'ElvUI' then
			...
			E.db["nameplates"]["units"]["PLAYER"]["castbar"]["yOffset"] = -18
			...
			E.db["nameplates"]["units"]["PLAYER"]["name"]["yOffset"] = -13
			...
			E.db["nameplates"]["units"]["PLAYER"]["power"]["text"]["format"] = "[power:current:shortvalue]"
			E.db["nameplates"]["units"]["PLAYER"]["power"]["text"]["parent"] = "Health"
			E.db["nameplates"]["units"]["PLAYER"]["power"]["text"]["yOffset"] = -12
