...
function ElvUI_EltreumUI:SetupLayoutDPS()
	...
	E.db["movers"]["ElvUF_TargetTargetMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-453,299"
	...
	--E.db["movers"]["RaidUtility_Mover"] = "TOP,ElvUIParent,TOP,-219,1" --has been removed from SLE
