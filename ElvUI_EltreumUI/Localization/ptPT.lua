...
local L = ElvUI[1].Libs.ACL:NewLocale("ElvUI", "ptPT")
...
L["Import MRT profile with raid cooldowns and other settings"] = true
L["You will need to swap to this profile in MRT"] = true
L["Overwrite"] = true
L["Copy"] = true
L["MRT is a suite of tools for raiding"] = true
