				...
				if UnitExists("focus") and focuscastbar then
					...
					if E.db.ElvUI_EltreumUI.unitframes.gradientmode.enable then
						...
						if (focuscastbar.notInterruptible) then --cant interrupt
							if E.db.ElvUI_EltreumUI.unitframes.gradientmode.enablefocuscastbarnoninterruptible then
								if E.db.unitframe.units.focus.castbar.reverse then
									if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor then
										if E.Retail then
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptiblecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptiblecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptiblecustom, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptiblecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptiblecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptiblecustom, a=1})
										else
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptiblecustom)
										end
									else
										if E.Retail then
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptible, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptible, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptible, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptible, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptible, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptible, a=1})
										else
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptible)
										end
									end
								elseif not E.db.unitframe.units.focus.castbar.reverse then
									if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor then
										if E.Retail then
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptiblecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptiblecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptiblecustom, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptiblecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptiblecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptiblecustom, a=1})
										else
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptiblecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptiblecustom)
										end
									else
										if E.Retail then
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptible, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptible, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptible, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptible, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptible, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptible, a=1})
										else
											focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1noninterruptible, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1noninterruptible)
										end
									end
								end
							end
						elseif (not focuscastbar.notInterruptible) and (not ElvUI_EltreumUI:CheckmMediaTagInterrupt()) then --can interrupt
							if E.db.ElvUI_EltreumUI.unitframes.gradientmode.enablefocuscastbar then
								if E.db.unitframe.units.focus.castbar.reverse then
									if UnitIsPlayer("focus") then
										if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor and not E.db.ElvUI_EltreumUI.unitframes.gradientmode.classcolorfocuscastbar then
											if E.db.unitframe.colors.transparentCastbar then
												if E.Retail then
													focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
												else
													focuscastbar:GetStatusBarTexture():SetGradientAlpha(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha)
												end
											else
												if E.Retail then
													focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom, a=1})
												else
													focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom)
												end
											end
										elseif E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor and E.db.ElvUI_EltreumUI.unitframes.gradientmode.classcolorfocuscastbar then
											if E.db.unitframe.colors.transparentCastbar then
												if E.Retail then
										...
										if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor and not E.db.ElvUI_EltreumUI.unitframes.gradientmode.classcolorfocuscastbar then
											...
											if E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarreactioninterruptable then
												if E.db.unitframe.colors.transparentCastbar then
													if E.Retail then
														if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor and E.db.ElvUI_EltreumUI.unitframes.gradientmode.classcolorfocuscastbar then
												...
												if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor then
													if E.db.unitframe.colors.transparentCastbar then
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
														else
															focuscastbar:GetStatusBarTexture():SetGradientAlpha(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha)
														end
													else
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom, a=1})
														else
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom)
														end
													end
												else
													if E.db.unitframe.colors.transparentCastbar then
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
														else
															focuscastbar:GetStatusBarTexture():SetGradientAlpha(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha)
														end
													else
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable, a=1})
														else
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable)
														end
													end
												end
											end
								...
								elseif not E.db.unitframe.units.focus.castbar.reverse then
									if UnitIsPlayer("focus") then
										if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor and not E.db.ElvUI_EltreumUI.unitframes.gradientmode.classcolorfocuscastbar then
											if E.db.unitframe.colors.transparentCastbar then
												if E.Retail then
													focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
												else
													focuscastbar:GetStatusBarTexture():SetGradientAlpha(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha)
												end
											else
												if E.Retail then
													focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom, a=1})
												else
													focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2custom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2custom)
												end
											end
										elseif E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor and E.db.ElvUI_EltreumUI.unitframes.gradientmode.classcolorfocuscastbar then
											if E.db.unitframe.colors.transparentCastbar then
										...
										if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor and not E.db.ElvUI_EltreumUI.unitframes.gradientmode.classcolorfocuscastbar then
											...
											if E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarreactioninterruptable then
												...
												if E.db.ElvUI_EltreumUI.unitframes.gradientmode.customcolor then
													if E.db.unitframe.colors.transparentCastbar then
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
														else
															focuscastbar:GetStatusBarTexture():SetGradientAlpha(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha)
														end
													else
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom, a=1})
														else
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptablecustom, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptablecustom)
														end
													end
												else
													if E.db.unitframe.colors.transparentCastbar then
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable, a=E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
														else
															focuscastbar:GetStatusBarTexture():SetGradientAlpha(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha)
														end
													else
														if E.Retail then
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable, a=1}, {r=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, g=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, b=E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable, a=1})
														else
															focuscastbar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB1interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarR2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarG2interruptable, E.db.ElvUI_EltreumUI.unitframes.gradientmode.focuscastbarB2interruptable)
														end
													end
												end
											end
