		...
		if E.db.ElvUI_EltreumUI.unitframes.gradientmode.enableaurabars then
			...
			if unit == "player" then
				if E.db.unitframe.colors.transparentAurabars then
					if E.Retail then
						bar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r-0.3, g-0.3, b-0.3, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r, g, b, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
					else
					...
					if E.Retail then
						bar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r-0.3, g-0.3, b-0.3, 1}, {r, g, b, 1})
					else
			...
			elseif unit == "target" then
				if E.db.unitframe.colors.transparentAurabars then
					if E.Retail then
						bar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r, g, b, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha}, {r-0.3, g-0.3, b-0.3, E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.backdropalpha})
					else
					...
					if E.Retail then
						bar:GetStatusBarTexture():SetGradient(E.db.ElvUI_EltreumUI.unitframes.gradientmode.orientation, {r, g, b, 1}, {r-0.3, g-0.3, b-0.3, 1})
					else
