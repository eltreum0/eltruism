			...
			for i = 1, 30 do --button seems to go to 20, but there might be more somewhere
				if _G["ImmersionQuestInfoItem" .. i] then
					if not _G["ImmersionQuestInfoItem" .. i].EltruismSkin then
						...
						_G["ImmersionQuestInfoItem" .. i].NameFrame.backdrop:SetPoint("TOPLEFT",_G["ImmersionQuestInfoItem" .. i .."Name"],"TOPLEFT",-3,0)
						_G["ImmersionQuestInfoItem" .. i].NameFrame.backdrop:SetPoint("BOTTOMRIGHT",_G["ImmersionQuestInfoItem" .. i .."Name"],"BOTTOMRIGHT",-6,-3)
				...
				if _G["ImmersionProgressItem" .. i] then
					if not _G["ImmersionProgressItem" .. i].EltruismSkin then
						...
						_G["ImmersionProgressItem" .. i].NameFrame.backdrop:SetPoint("BOTTOMRIGHT",_G["ImmersionProgressItem" .. i .."Name"],"BOTTOMRIGHT",-6,-3)
