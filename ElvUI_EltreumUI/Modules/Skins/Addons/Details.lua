				...
				if E.db.ElvUI_EltreumUI.skins.detailsgradientname then
					...
					hooksecurefunc(Details.atributo_damage,"RefreshLine", function(_,_, lineContainer, whichRowLine)
						...
						if thisLine.lineText1 then
							thisLine.lineText1:SetText(ElvUI_EltreumUI:GradientName(thisLine.colocacao .. ". " .. ElvUI_EltreumUI:ShortenString(thisLine.minha_tabela:GetDisplayName(), 11, true), thisLine.minha_tabela:class()))
						end
					end)
					--gradient name (heal)
