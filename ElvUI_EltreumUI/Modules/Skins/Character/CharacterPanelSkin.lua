...
function ElvUI_EltreumUI:ExpandedCharacterStats()
	...
	if E.Retail then
		...
		if E.db.ElvUI_EltreumUI.skins.classicarmory then
			...
			CharacterStatsPane.EnhancementsCategory.Title.StatusLine:GetStatusBarTexture():SetGradient("HORIZONTAL", {r=statgradients[E.myclass]["r1"],g=statgradients[E.myclass]["g1"],b=statgradients[E.myclass]["b1"],a= 1}, {r=statgradients[E.myclass]["r2"],g=statgradients[E.myclass]["g2"],g=statgradients[E.myclass]["b2"],a= 1})
