...
function ElvUI_EltreumUI:ChangeGroupUnitframe(unit, r, g, b) --() --(unit, r, g, b)
	--[[local _, unitclass
			...
			for i = 1, header:GetNumChildren() do
				...
				for j = 1, group:GetNumChildren() do
					...
					if unitbutton and unitbutton.Health then --and not test[j] == unitbutton then
						--unitbutton.Health:SetStatusBarColor(truer,trueg,trueb)
						local r1,g1,b1 = unitbutton.Health:GetStatusBarColor()
						local r = tostring(r1)
						local g = tostring(g1)
						local b = tostring(b1)
						--print(unit1class, r1, truer)
						if tostring(g1) == tostring(trueg) and tostring(r1) == tostring(truer) and tostring(b1) == tostring(trueb) then --and g1 == trueg and b1 == trueb then
							print("matches")
