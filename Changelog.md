...
Note: There are too many changes to list here, 12.0 is a huge departure from what the game used to be. Expect tags and more to not work in some scenarios.  
---
### 4.4.4
