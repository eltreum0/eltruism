						...
						mediaoptions = {
							...
							args = {
								...
								expandedstable = {
									order = 21,
									type = "description",
									name = "Expand Hunter Stables to show all pets and improve search",
									width = "full",
								},
								stableenable = {
									order = 22,
									type = 'toggle',
									name = 'Enable',
									desc = 'Enable the Expanded Stable',
								...
								widertransmog = {
									order = 24,
									type = "description",
									name = "Expand Transmog Window to better show your character",
									width = "full",
								},
								widetransmogenable = {
									order = 25,
									type = 'toggle',
									name = 'Enable',
									desc = 'Enable the Wider Transmog Window',
								...
								rogueorderhallautoopen = {
									order = 27,
									type = "description",
									name = "Auto open the Rogue Order Hall, to avoid opening hold CTRL or SHIFT or ALT while talking to the NPC",
									width = "full",
								},
								rogueenable = {
									order = 28,
						...
						nameplatepower = {
							...
							args = {
								...
								enableautoadjust = {
									order = 4,
									type = 'toggle',
									name = 'Enable Autoadjusting the Vertical Position of the Power Bar',
									desc = 'Power Bar will move automatically based on class/spec/druid form',
									width = 'full',
								...
								powerbarYoffset = {
									type = 'range',
									name = 'Select the Y Offset for the Power Bar (Default 16)',
									desc = 'Set Y Offset',
									order = 5,
									min = -100,
									max = 100,
								...
								powerbarsizeX = {
									type = 'range',
									name = 'Select the Horizontal Size of the Power Bar (Default 132)',
									desc = 'Set Horizontal Size',
									order = 6,
									min = 10,
									max = 300,
									step = 1,
								...
								powerbarsizeY = {
									type = 'range',
									name = 'Select the Vertical Size of the Power Bar (Default 6)',
									desc = 'Set Horizontal Size',
									order = 7,
									min = 2,
									max = 20,
								...
								sharedmediatexture = {
									...
									name = "Choose the Power Bar Texture",
									desc = 'Select a Texture',
						...
						chatOptions = {
							...
							args = {
								chatfadeenable = {
									order = 1,
									type = 'toggle',
									name = 'Enable ElvUI Chat modifications',
									width = 'full',
									desc = 'Add fade over time, and mouse over to left and right chat panels',
								...
								description2 = {
									order = 4,
									type = "description",
									name = "Add mouse over to the left chat panel",
								},
								leftmouseover = {
									order = 5,
									type = 'toggle',
									name = 'Left Chat Mouse Over',
									--width = 'full',
									desc = 'Toggle the option',
								...
								description3 = {
									order = 6,
									type = "description",
									name = "Add a fade to the left chat panel, controlled by ElvUI Chat > Text Fade > Inactivity Timer",
								},
								leftfade = {
									order = 7,
									type = 'toggle',
									name = 'Left Inactivity Fader',
									--width = 'full',
									desc = 'Toggle the option',
									disabled = function() return not E.db.ElvUI_EltreumUI.chat.enable end,
								...
								description5 = {
									order = 10,
									type = "description",
									name = "Add a fade to the right chat panel, controlled by ElvUI Chat > Text Fade > Inactivity Timer",
								},
								rightfade = {
									order = 11,
									type = 'toggle',
									name = 'Right Inactivity Fader',
									--width = 'full',
									desc = 'Toggle the option',
									disabled = function() return not E.db.ElvUI_EltreumUI.chat.enable end,
								...
								rightcombathide = {
									order = 14,
									type = 'toggle',
									name = 'Hide Right Chat in Combat',
									width = 'full',
									desc = 'Toggle the option',
									disabled = function() return not E.db.ElvUI_EltreumUI.chat.enable end,
