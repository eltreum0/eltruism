						...
						friendlynameplate = {
							...
							args = {
								hidehealthinsideinstances = {
									...
									width = 'full',
									disabled = function() return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.disablefriendly or E.private.ElvUI_EltreumUI.friendlynameplatetoggle.hidefriendly end,
									get = function(info) return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.friendlynames end,
									set = function(_, value) E.private.ElvUI_EltreumUI.friendlynameplatetoggle.friendlynames = value E:StaticPopup_Show('PRIVATE_RL') end,
								},
								nofriendlyinstances = {
									order = 1,
									type = 'toggle',
									...
									width = 'full',
									disabled = function() return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.friendlynames or E.private.ElvUI_EltreumUI.friendlynameplatetoggle.hidefriendly end,
									get = function(info) return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.disablefriendly end,
									set = function(_, value) E.private.ElvUI_EltreumUI.friendlynameplatetoggle.disablefriendly = value E:StaticPopup_Show('PRIVATE_RL') end,
								},
								dontshowfriendlyatall = {
									...
									width = 'full',
									disabled = function() return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.friendlynames or E.private.ElvUI_EltreumUI.friendlynameplatetoggle.disablefriendly end,
									get = function(info) return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.hidefriendly end,
									set = function(_, value) E.private.ElvUI_EltreumUI.friendlynameplatetoggle.hidefriendly = value E:StaticPopup_Show('PRIVATE_RL') end,
								},
							},
						},
						header3 = {
