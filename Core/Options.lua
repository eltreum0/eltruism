					...
					friendlynameplate = {
						...
						args = {
							showfriendlynameonly = {
								order = 1,
								type = 'toggle',
								name = 'Show Friendly Nameplates but Hide Heathbar',
								desc = 'Show Friendly Nameplates but Hide Heathbar',
								width = 'full',
								disabled = function() return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.disablefriendly end,
							...
							dontshowfriendly = {
								...
								width = 'full',
								disabled = function() return E.private.ElvUI_EltreumUI.friendlynameplatetoggle.friendlynames end,
