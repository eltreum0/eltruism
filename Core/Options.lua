					...
					args = {
						lootsetting = {
							...
							args = {
								...
								lootscale = {
									type = 'range',
									name = 'Change the scale of the Loot Text',
									...
									set = function(_, value) E.db.ElvUI_EltreumUI.loottext.scale = value ReloadUI() end,
									confirm = true,
								},
								addgaptobenice = {
									order = 5,
								...
								lootscalereset = {
									...
									order = 9,
									disabled = function() return not E.db.ElvUI_EltreumUI.loottext.enable end,
									func = function() E.db.ElvUI_EltreumUI.loottext.scale = 0.65 ReloadUI() end,
									confirm = true,
								},
								header2 = {
									order = 10,
