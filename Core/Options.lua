								...
								name = 'Select a Type',
									args = {
										...
										autocast = {
											...
											set = function(info, value) E.db.ElvUI_EltreumUI.glow.autocast = value E:StaticPopup_Show('PRIVATE_RL') end,
										},
										pixel = {
											type = 'toggle',
											name = 'Pixel',
											...
											set = function(info, value) E.db.ElvUI_EltreumUI.glow.pixel = value E:StaticPopup_Show('PRIVATE_RL') end,
										},
										blizzard = {
											type = 'toggle',
											name = 'Blizzard',
											...
											set = function(info, value) E.db.ElvUI_EltreumUI.glow.blizzard = value E:StaticPopup_Show('PRIVATE_RL') end,
										},
									},
								},
							},
						...
						grouplayout = {
							...
							args = {
								...
								alternativegroups = {
									...
									func = function() ElvUI_EltreumUI:AlternativeGroupsDPS() ReloadUI() end,
									confirm = true,
								},
								originalgroups = {
									order = 3,
									...
									func = function() ElvUI_EltreumUI:OriginalGroupsDPS() ReloadUI() end,
									confirm = true,
								},
							},
						},
						...
						cursorsettings = {
							...
							args = {
								enable = {
									order = 1,
									type = 'toggle',
									name = 'Enable cursor GCD and Cast',
									desc = 'Add a gcd and cast ring to the cursor',
									width = 'full',
									confirm = true,
									get = function(info) return E.db.ElvUI_EltreumUI.cursor.enable end,
									set = function(info, value) E.db.ElvUI_EltreumUI.cursor.enable = value ReloadUI() end,
								},
								header1 = {
									order = 2,
									type = "description",
								...
								ringtexture = {
									...
									args = {
										...
										showring1 = {
											...
											name = 'Type 1',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring1.tga' ReloadUI() end,
										},
										showring2 = {
											order = 2,
											type = "execute",
											...
											name = 'Type 2',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring2.tga' ReloadUI()  end,
										},
										showring3 = {
											order = 3,
											type = "execute",
											...
											name = 'Type 3',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring3.tga' ReloadUI() end,
										},
										showring4 = {
											order = 4,
											type = "execute",
											...
											name = 'Type 4',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring4.tga' ReloadUI() end,
										},
										showring5 = {
											order = 5,
											type = "execute",
											...
											name = 'Type 5',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring5.tga' ReloadUI() end,
										},
										showring6 = {
											order = 6,
											type = "execute",
											...
											name = 'Type 6',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring6.tga' ReloadUI() end,
										},
										showring7 = {
											order = 7,
											type = "execute",
											...
											name = 'Type 7',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring7.tga' ReloadUI() end,
										},
										showring8 = {
											order = 8,
											type = "execute",
											...
											name = 'Type 8',
											confirm = true,
											func = function() E.db.ElvUI_EltreumUI.cursor.ring = 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\Cursor\\ring8.tga' ReloadUI() end,
										},
										--[[header1 = {
											order = 98,
											type = "description",
										...
										cursortexturepicker = {
											order = 99,
											type = 'select',
											name = 'Choose a cursor from the gallery:',
											desc = 'Choose this as the cursor texture',
											confirm = true,
											values = function() return ElvUI_EltreumUI:ListofCursors() end,
							                style = 'radio',
											get = function(info) return E.db.ElvUI_EltreumUI.cursor.ring end,
											set = function(info, value) E.db.ElvUI_EltreumUI.cursor.ring = value ReloadUI() end,
										},]]--
									},
								},
							},
						...
						waypointetasetting = {
							...
							args = {
								...
								enable = {
									...
									set = function(info, value) E.db.ElvUI_EltreumUI.waypointetasetting.enable = value E:StaticPopup_Show('PRIVATE_RL') end,
								},
							},
						},
						waytext = {
						...
						friendlynameplate = {
							...
							args = {
								...
								nofriendlyinstances = {
									...
									set = function(_, value) E.db.ElvUI_EltreumUI.friendlynameplatetoggle.disablefriendly = value E:StaticPopup_Show('PRIVATE_RL') end,
								},
								dontshowfriendlyatall = {
									...
									set = function(_, value) E.db.ElvUI_EltreumUI.friendlynameplatetoggle.hidefriendly = value E:StaticPopup_Show('PRIVATE_RL') end,
								},
							},
						},
						header3 = {
						...
						addons = {
							...
							args = {
								...
								questie = {
									...
									name = 'Questie',
									desc = 'Reset to Eltreum UI defaults.',
									func = function() ElvUI_EltreumUI:AddonSetupQuestie() ReloadUI() end,
									confirm = true,
								},
								immersion = {
									order = 2,
					...
					args = {
						glow = {
							...
							args = {
								...
								set = function(_, value) E.db.ElvUI_EltreumUI.glow.enable = value E:StaticPopup_Show('PRIVATE_RL') end,
								},
								addagaphere = {
								order = 2,
								type = "description",
