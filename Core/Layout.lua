...
elseif ElvUI_EltreumUI.Classic then
	function ElvUI_EltreumUI:SetupLayout(layout)
		...
		if layout == 'dps' then
			...
			E.db["movers"]["QuestWatchFrameMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-208,-357"
			E.db["movers"]["TooltipMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,329,-154"
			E.db["movers"]["TorghastBuffsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-4,-346"
			E.db["movers"]["TotemBarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,256"
			E.db["movers"]["VehicleLeaveButton"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-183,-180"
			...
			--E.db["unitframe"]["units"]["pet"]["power"]["width"] = "spaced"
			E.db["unitframe"]["units"]["pet"]["power"]["width"] = "filled"
			...
			E.db["unitframe"]["units"]["tank"]["rdebuffs"]["size"] = 20
			E.db["unitframe"]["units"]["tank"]["targetsGroup"]["name"]["text_format"] = "[namecolor][name:abbrev]"
			E.db["unitframe"]["units"]["tank"]["targetsGroup"]["raidicon"]["attachTo"] = "LEFT"
			E.db["unitframe"]["units"]["tank"]["targetsGroup"]["raidicon"]["size"] = 8
			E.db["unitframe"]["units"]["tank"]["targetsGroup"]["raidicon"]["yOffset"] = 0
			E.db["unitframe"]["units"]["tank"]["targetsGroup"]["height"] = 30
			E.db["unitframe"]["units"]["tank"]["targetsGroup"]["enable"] = false
...
elseif ElvUI_EltreumUI.TBC then
	function ElvUI_EltreumUI:SetupLayout(layout)
		...
		E.db["general"]["minimap"]["icons"]["mail"]["xOffset"] = 0
		E.db["general"]["minimap"]["icons"]["mail"]["yOffset"] = -27
		E.db["general"]["minimap"]["icons"]["tracking"]["enable"] = false
		E.db["general"]["minimap"]["locationFont"] = "Kimberley"
		E.db["general"]["minimap"]["locationFontOutline"] = "THICKOUTLINE"
		E.db["general"]["minimap"]["locationFontSize"] = 14
		E.db["general"]["minimap"]["locationText"] = "SHOW"
