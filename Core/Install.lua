	...
	ElvUI_EltreumUI.InstallerData = {
		...
		Pages = {
			...
			[5] = function()
				...
				PluginInstallFrame.Desc3:SetText(L["Remember to swap the second window to Healing Done"])
			...
			[7] = function()
				PluginInstallFrame.SubTitle:SetFormattedText(L["Exorsus Raid Tools"])
				PluginInstallFrame.Desc1:SetText(L["Import EXRT profile with raid cooldowns and other settings"])
				PluginInstallFrame.Desc2:SetText(L["You will need to swap to this profile in ExRT"])
				PluginInstallFrame.Desc3:SetText('|cffff0000'..L["Your current settings will be lost with overwrite, please back them up"]..'|r')
				PluginInstallFrame.Desc4:SetText(L["Importance: "]..'|cff82B4ff'..L["Optional"]..'|r')
				PluginInstallFrame.Option1:Enable()
				PluginInstallFrame.Option1:Show()
				...
				if (not IsAddOnLoaded("ExRT")) then
					PluginInstallFrame.SubTitle:SetFormattedText("|cffff0000"..L["WARNING"])
					PluginInstallFrame.Desc1:SetText(L["Exorsus Raid Tools"]..L[" is not installed or enabled"])
					PluginInstallFrame.Desc2:SetText(L["ExRT is a suite of tools for raiding"])
