...
ElvUI_EltreumUI.InstallerData = {
	...
	Pages = {
		...
		[5] = function()
			...
			PluginInstallFrame.Desc1:SetText('Import GladiusEx profile')
		...
		[6] = function()
			...
			PluginInstallFrame.Desc2:SetText('Remember to swap the second window to Healing Done')
			PluginInstallFrame.Desc3:SetText('Importance: |c4682B4ffHigh|r')
			PluginInstallFrame.Option1:Show()
