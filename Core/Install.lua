...
ElvUI_EltreumUI.InstallerData = {
	...
	Pages = {
		...
		[4] = function()
			...
			PluginInstallFrame.Desc3:SetText('Importance: |cff82B4ffOptional|r')
		...
		[6] = function()
			...
			PluginInstallFrame.Desc3:SetText('Remember to swap the second window to Healing Done')
			PluginInstallFrame.Desc4:SetText('Importance: |cff82B4ffHigh|r')
			PluginInstallFrame.Option1:Show()
		...
		[12] = function()
			...
			PluginInstallFrame.Desc3:SetText('Direct links can be found in the Eltruism menu or you can click the button for a link to my profile')
			PluginInstallFrame.Option1:Show()
