...
function ElvUI_EltreumUI:BorderTests()
	local classcolor = E:ClassColor(E.myclass, true)

	local xplayer = E.db.ElvUI_EltreumUI.borders.xplayer
	local yplayer = E.db.ElvUI_EltreumUI.borders.yplayer
	local xtarget = E.db.ElvUI_EltreumUI.borders.xtarget
	local ytarget = E.db.ElvUI_EltreumUI.borders.ytarget
	...
	--local xbar7 = E.db.ElvUI_EltreumUI.borders.bar7xborder
	--local ybar7 = E.db.ElvUI_EltreumUI.borders.bar7yborder
	--local xbar8 = E.db.ElvUI_EltreumUI.borders.bar8xborder
	--local ybar8 = E.db.ElvUI_EltreumUI.borders.bar8yborder
	--local xbar9 = E.db.ElvUI_EltreumUI.borders.bar9xborder
	--local ybar9 = E.db.ElvUI_EltreumUI.borders.bar9yborder
	--local xbar10 = E.db.ElvUI_EltreumUI.borders.bar10xborder
	--local ybar10 = E.db.ElvUI_EltreumUI.borders.bar10yborder
	if E.db.ElvUI_EltreumUI.borders.borders then
		local playerborder = CreateFrame("Frame", nil, _G.ElvUF_Player, "BackdropTemplate")
		playerborder:SetSize(xplayer, yplayer)
		playerborder:SetPoint("CENTER", _G.ElvUF_Player, "CENTER", 0, 0)
		playerborder:SetBackdrop( {
		    edgeFile = "Interface\\addons\\eltreumbord.tga",
