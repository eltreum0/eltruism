...
function ElvUI_EltreumUI:SetupNamePlates(addon)
	...
	if addon == 'ElvUI' then
		...
		E.db["nameplates"]["colors"]["glowColor"]["b"] = 0.039215601980686
		E.db["nameplates"]["colors"]["glowColor"]["g"] = 0.48627343773842
		E.db["nameplates"]["colors"]["glowColor"]["r"] = 0.99999779462814
		...
		E.db["nameplates"]["units"]["ENEMY_NPC"]["health"]["text"]["yOffset"] = -2
		...
		E.db["nameplates"]["units"]["ENEMY_PLAYER"]["pvpclassificationindicator"]["enable"] = false
		...
		E.db["nameplates"]["units"]["FRIENDLY_PLAYER"]["pvpclassificationindicator"]["enable"] = false
		...
		E.db["nameplates"]["units"]["TARGET"]["arrowSpacing"] = 9
